...
export function SDLogo() {
  return (
    <svg
      className="w-[44px] h-[37px] md:w-[55px] md:h-[46px] text-site-icon"
      viewBox="0 0 844 704"
      fill="none"
...
export function MenuIcon() {
  return (
    <svg className="w-8 h-8 md:w-10 md:h-10 text-site-icon" viewBox="0 0 44 44" fill="none" aria-hidden>
      <rect x="1.5" y="1.5" width="41" height="41" rx="7.5" className="stroke-current" strokeWidth="3" />
      <line x1="11" y1="15" x2="33" y2="15" className="stroke-current" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="11" y1="22" x2="33" y2="22" className="stroke-current" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="11" y1="29" x2="33" y2="29" className="stroke-current" strokeWidth="2.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-site-nav flex items-center justify-between px-5 md:px-8 py-4 md:py-5 border-b border-black/5 dark:border-white/10 transition-colors duration-300">
      <Link href="/" aria-label="Home" className="text-site-icon">
        <SDLogo />
      </Link>
      <div className="flex items-center gap-4 md:gap-6">
        <Link
          href="/portfolio"
          className="md:block text-[12px] font-bold tracking-[0.12em] uppercase text-site-nav-fg hover:opacity-50 transition-opacity"
        >
          Portfolio
        </Link>
        <button
          ...
          className="text-site-nav-fg hover:opacity-60 transition-opacity"
        >
